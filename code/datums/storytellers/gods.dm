/datum/storyteller/astrata
	...
	influence_sets = list(
		...
		"Set 4" = list(
			...
			STATS_PRAYERS_MADE = list("name" = "Prayers made:", "points" = 1.7, "capacity" = 65),
		),
		"Set 5" = list(
			STATS_TAXES_COLLECTED = list("name" = "Taxes collected:", "points" = 0.21, "capacity" = 80),
			STATS_SLURS_SPOKEN = list("name" = "Slurs spoken:", "points" = 1.6, "capacity" = 80),
		)
	)
...
/datum/storyteller/ravox
	...
	influence_sets = list(
		...
		"Set 5" = list(
			STATS_UNDERWORLD_DUELS = list("name" = "Underworld duels:", "points" = 5.75, "capacity" = 65),
		)
	)
...
/datum/storyteller/abyssor
	...
	influence_sets = list(
		...
		"Set 3" = list(
			STATS_ABYSSOR_REMEMBERED = list("name" = "Abyssor remembered:", "points" = 0.9, "capacity" = 40),
		),
		"Set 4" = list(
			STATS_LEECHES_EMBEDDED = list("name" = "Leeches embedded:", "points" = 0.75, "capacity" = 70),
		),
		"Set 5" = list(
			STATS_PEOPLE_DROWNED = list("name" = "People drowned:", "points" = 10, "capacity" = 75),
			STATS_BATHS_TAKEN = list("name" = "Baths taken:", "points" = 3.75, "capacity" = 60),
		)
	)
...
/datum/storyteller/necra
	...
	influence_sets = list(
		...
		"Set 2" = list(
			STATS_GRAVES_CONSECRATED = list("name" = "Graves consecrated:", "points" = 6.5, "capacity" = 80),
		),
		"Set 3" = list(
			STATS_GRAVES_ROBBED = list("name" = "Graves robbed:", "points" = -3.75, "capacity" = -40),
			STATS_ALIVE_SNOW_ELVES = list("name" = "Number of elves:", "points" = 5, "capacity" = 55),
		),
		"Set 4" = list(
...
/datum/storyteller/pestra
	...
	influence_sets = list(
		...
		"Set 2" = list(
			STATS_WOUNDS_SEWED = list("name" = "Wounds sewed up:", "points" = 0.485, "capacity" = 100),
		),
		"Set 3" = list(
...
/datum/storyteller/malum
	...
	influence_sets = list(
		"Set 1" = list(
			STATS_MASTERWORKS_FORGED = list("name" = "Masterworks forged:", "points" = 15, "capacity" = 85),
		),
		"Set 2" = list(
			STATS_ROCKS_MINED = list("name" = "Rocks mined:", "points" = 0.26, "capacity" = 100),
		),
		"Set 3" = list(
			STATS_CRAFT_SKILLS = list("name" = "Craft skills learned:", "points" = 0.57, "capacity" = 90),
		),
		"Set 4" = list(
...
/datum/storyteller/eora
	...
	influence_sets = list(
		"Set 1" = list(
			STATS_PARENTS = list("name" = "Number of parents:", "points" = 9.5, "capacity" = 90),
			STATS_CHILD_POPULATION = list("name" = "Number of children:", "points" = 7.25, "capacity" = 75),
		),
		"Set 2" = list(
			STATS_MARRIAGES = list("name" = "Marriages made:", "points" = 25, "capacity" = 75),
			STATS_PACIFISTS = list("name" = "Number of pacifists:", "points" = 16, "capacity" = 75),
		),
		"Set 3" = list(
			STATS_HUGS_MADE = list("name" = "Hugs made:", "points" = 2.5, "capacity" = 70),
		),
		"Set 4" = list(
			STATS_HANDS_HELD = list("name" = "Hands held:", "points" = 2.1, "capacity" = 70),
		),
		"Set 5" = list(
...
/datum/storyteller/zizo
	...
	influence_sets = list(
		"Set 1" = list(
			STATS_ZIZO_PRAISED = list("name" = "Zizo praised:", "points" = 0.95, "capacity" = 40),
...
/datum/storyteller/baotha
	...
	influence_sets = list(
		"Set 1" = list(
			STATS_DRUGS_SNORTED = list("name" = "Drugs snorted:", "points" = 4.1, "capacity" = 85),
		),
		"Set 2" = list(
...
/datum/storyteller/graggar
	...
	influence_sets = list(
		...
		"Set 2" = list(
			STATS_BLOOD_SPILT = list("name" = "Blood spilt:", "points" = 0.0283, "capacity" = 90),
		),
		"Set 3" = list(
		...
		"Set 4" = list(
			...
			STATS_ALIVE_HALF_ORCS = list("name" = "Number of half-orcs:", "points" = 6.75, "capacity" = 70),
		),
		"Set 5" = list(
...
/datum/storyteller/matthios
	...
	influence_sets = list(
		...
		"Set 3" = list(
			...
			STATS_KLEPTOMANIACS = list("name" = "Number of kleptomaniacs:", "points" = 11, "capacity" = 70),
		),
		"Set 4" = list(
			STATS_DODGES = list("name" = "Dodges made:", "points" = 0.084, "capacity" = 100),
		),
		"Set 5" = list(
