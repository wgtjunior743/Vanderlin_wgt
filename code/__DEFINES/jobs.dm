...
#define JOB_LEADERSHIP_ROLES_LIST	list(/datum/job/priest, /datum/job/captain, /datum/job/lord, /datum/job/inquisitor,/datum/job/advclass/puritan/inspector, /datum/job/advclass/puritan/ordinator, /datum/job/forestwarden, /datum/job/town_elder,  /datum/job/advclass/town_elder/mayor, /datum/job/advclass/town_elder/master_of_crafts_and_labor, /datum/job/advclass/town_elder/hearth_acolyte, /datum/job/advclass/town_elder/lorekeeper, /datum/job/advclass/town_elder/dreamwatcher)
