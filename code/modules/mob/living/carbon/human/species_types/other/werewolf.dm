...
/datum/species/werewolf
	...
	inherent_traits = list(TRAIT_NOSTAMINA, TRAIT_RESISTCOLD, TRAIT_RESISTHIGHPRESSURE, TRAIT_RESISTLOWPRESSURE, TRAIT_RADIMMUNE, TRAIT_NODISMEMBER, TRAIT_LYCANRESILENCE)
