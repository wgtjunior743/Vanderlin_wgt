...
/datum/job/advclass/royalknight/arcane
	title = "Arcane Knight"
	tutorial = "You are a rare fusion of steel and sorcery, schooled in both the blade and the arcane.\
	Where others rely solely on strength or spellcraft, you wield both in unison, forging power through discipline. \
	Yet such mastery comes at a price, your gifts draw envy, fear, and expectation in equal measure. \
	Walk wisely, Knight, for the world will demand proof that your magic serves more than your own ambition."

	outfit = /datum/outfit/royalknight/arcane
	allowed_patrons = list(/datum/patron/divine/noc, /datum/patron/inhumen/zizo)
	category_tags = list(CTAG_ROYALKNIGHT)

/datum/outfit/royalknight/arcane/pre_equip(mob/living/carbon/human/H)
	. = ..()
	...
	backpack_contents = list(/obj/item/storage/keyring/manorguard = 1, /obj/item/book/granter/spellbook/adept = 1, /obj/item/chalk = 1, /obj/item/reagent_containers/glass/bottle/manapot = 1)
