...
/obj/item/herbseed/proc/try_plant_seed(mob/living/user, obj/structure/soil/soil)
	...
	addtimer(CALLBACK(src,TYPE_PROC_REF(/obj/item/herbseed,become_plant),soil,makes_herb),3.5 MINUTES)
...
/obj/item/herbseed/euphorbia
	makes_herb = /obj/structure/flora/grass/herb/euphorbia
